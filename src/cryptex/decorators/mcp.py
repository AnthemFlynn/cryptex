...
class MCPToolRegistry:
    ...
    def get_tool_protection(self, tool_name: str) -> Optional[MCPToolProtection]:
...
def register_protected_tool(tool_name: str, 
                          protection: MCPToolProtection,
                          metadata: Optional[dict] = None) -> None:
...
def protect_file_tool(config_path: Optional[str] = None) -> Callable[[F], F]:
...
def protect_api_tool(api_secrets: Optional[List[str]] = None, 
...
def protect_database_tool(config_path: Optional[str] = None) -> Callable[[F], F]:
